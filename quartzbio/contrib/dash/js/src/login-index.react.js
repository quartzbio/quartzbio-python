 ...
 * - Clicking on a login button will launch a new window with the QuartzBio
 * - QuartzBio will redirect that window to defined redirect URL when complete
...
class Login extends Component {
    ...
    oauthPopUp() {
        const popupWindow = PopupCenter(
            // TODO: Fix https://github.com/quartzbio/www.quartzbio.com/issues/1179
    ...
    render() {
        return (
            <div id="dash-auth--login__container" className="container">
                ...
                <h4>
                    {'Log in to QuartzBio to continue'}
                </h4>
                ...
                <div className="caption">
                  <span>
                    {'This app requires a QuartzBio account.'}
                  </span>
                  <br />
                  <a href={'mailto:support@quartzbio.com'}>
                    {'Contact Support'}
                  </a>
                </div>
            </div>
