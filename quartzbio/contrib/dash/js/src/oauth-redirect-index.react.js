...
// const OAUTH_COOKIE_NAME = 'quartzbio_oauth_token';
const LOGIN_PATHNAME = '_dash-login';
const IS_AUTHORIZED_PATHNAME = '_is-authorized';

/**
 * OAuth redirect component
 * - Looks for an oauth token in the URL as provided by the QuartzBio redirect
        ...
        if (isEmpty(loginRequest) || loginRequest.status === 'loading') {
            ...
            content = (
                <div>
                    ...
                    <p>Please contact QuartzBio Support or try again.</p>
