...
def launch_ipython_shell(args):  # pylint: disable=unused-argument
    """Open the QuartzBio shell (IPython wrapper)"""
    try:
        import IPython  # noqa
    except ImportError:
        _print(
            "The QuartzBio Python shell requires IPython.\n"
    ...
    _print(
        "WARNING: Please upgrade IPython (you are running version: {})".format(
            IPython.__version__
        )
    )
...
def launch_ipython_5_shell(args):
    ...
    try:
        ...
        c.InteractiveShell.banner1 = "QuartzBio Python shell started.\n"
...
def launch_ipython_legacy_shell(args):  # pylint: disable=unused-argument
    ...
    try:
        ...
        prompt_config.in_template = "[QuartzBio] In <\\#>: "
        prompt_config.in2_template = "   .\\D.: "
        prompt_config.out_template = "Out<\\#>: "
        banner1 = "\nQuartzBio Python shell started."

        exit_msg = "Quitting QuartzBio shell."
    else:
