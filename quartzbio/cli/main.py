...
class QuartzBioArgumentParser(argparse.ArgumentParser):
    """
    Main parser for the QuartzBio command line client.
    """
    ...
    subcommands = {
        ...
        "tutorial": {
            "func": print_tutorial,
            "help": "Show the QuartzBio Python Tutorial",
        },
        "shell": {
            "func": launch_ipython_shell,
            "help": "Open the QuartzBio Python shell",
        },
        "import": {
            "func": data.import_file,
            "help": "Import a local file into a QuartzBio dataset",
            "arguments": [
                {
                    "flags": "--create-vault",
                    "action": "store_true",
        ...
        "create-dataset": {
            ...
            "help": "Create a QuartzBio dataset",
            "arguments": [
                {
                    "flags": "--create-vault",
                    "action": "store_true",
        ...
        "upload": {
            "func": data.upload,
            "help": "Upload a file or directory to a QuartzBio Vault",
            "arguments": [
                {
                    "flags": "--full-path",
        ...
        "ls": {
            "func": data.ls,
            "help": "List files and directories in a QuartzBio Vault",
            "arguments": [
                {
                    "flags": "--recursive",
        ...
        "download": {
            "func": data.download,
            "help": "Download one or more files from a QuartzBio Vault.",
            "arguments": [
                {
                    "flags": "--dry-run",
                ...
                {
                    "flags": "full_path",
                    "help": "The full path to the files on QuartzBio. Supports "
    ...
    def __init__(self, *args, **kwargs):
        super(QuartzBioArgumentParser, self).__init__(*args, **kwargs)
        self._optionals.title = "QuartzBio Options"
        self.add_argument(
            "--version", action="version", version=quartzbio.version.VERSION
        )
        self.add_argument(
            "--api-host",
    ...
    def _add_subcommands(self):
        ...
        """
        subcmd_params = {"title": "QuartzBio Commands", "dest": "subcommands"}
    ...
    def parse_quartzbio_args(self, args=None, namespace=None):
        """
