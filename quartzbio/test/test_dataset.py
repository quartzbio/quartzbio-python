...
class DatasetTests(QuartzBioTestCase):
    """
    Test Dataset, DatasetField, and Facets
    """

    def test_dataset_retrieval(self):
        dataset = self.client.Dataset.get_by_full_path(self.TEST_DATASET_FULL_PATH)
    ...
    def test_dataset_tree_traversal_shortcuts(self):
        ...
        # get vault object
        self.assertEqual(dataset.vault_object.full_path, self.TEST_DATASET_FULL_PATH)
    ...
    def test_dataset_fields(self):
        ...
        self.assertTrue(
            "id" in dataset_field, "Should be able to get id in list of dataset fields"
        )
