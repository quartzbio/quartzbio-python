...
import unittest
from quartzbio.utils import tabulate as t
from quartzbio.utils import printing as p
...
class TestTabulate(unittest.TestCase):
    ...
    def test_align(self):
        ...
        self.assertEqual(
            t._align_column(
                ["12.345", "-1234.5", "1.23", "1234.5", "1e+234", "1.0e234"], "decimal"
            ),
            [
                "   12.345  ",
                "-1234.5    ",
    ...
    def test_column_type(self):
        ...
        self.assertEqual(
            t._column_type(["four", "\u043f\u044f\u0442\u044c"]), t._text_type
        )
...
"""
        ...
        self.assertEqual(got, expected[1:-1], "simple separated format table")
        ####################################################################
...
"""
        ...
        # [-1:1] below to remove leading and trailing "\n"s above
        self.assertEqual(
            t.tabulate(tbl, hrow), expected[1:-1], "org mode with header and unicode"
        )
...
"""
        ...
        got = t.tabulate(
            data, headers=("Fields", "Data"), aligns=("right", "left"), sort=True
        )
...
"""
        got = t.tabulate(
            data, headers=("Fields", "Data"), aligns=("right", "left"), sort=False
        )
        self.assertEqual(got, expected[1:-1], "mixed data with arrays; unsorted")
