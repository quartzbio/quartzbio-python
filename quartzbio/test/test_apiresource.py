...
class APIResourceTests(QuartzBioTestCase):
    ...
    def test_apiresource_serialize_metadata(self):
        folder_no_metadata = self.client.Object.get_or_create_by_full_path(
        ...
        folder_with_metadata = self.client.Object.get_or_create_by_full_path(
            "~/{}".format(uuid.uuid4()),
            object_type="folder",
