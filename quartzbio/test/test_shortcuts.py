...
from quartzbio.cli.data import should_exclude
from quartzbio.test.client_mocks import fake_vault_all
from quartzbio.test.client_mocks import fake_vault_create
from quartzbio.test.client_mocks import fake_object_all
from quartzbio.test.client_mocks import fake_object_create
from quartzbio.test.client_mocks import fake_object_retrieve
from quartzbio.test.client_mocks import fake_dataset_tmpl_create
from quartzbio.test.client_mocks import fake_dataset_tmpl_retrieve
from quartzbio.test.client_mocks import fake_dataset_import_create
from quartzbio.test.client_mocks import fake_dataset_get_or_create
...
class CreateDatasetTests(CLITests):
    @mock.patch("quartzbio.resource.Vault.all")
    @mock.patch("quartzbio.resource.Object.all")
    @mock.patch("quartzbio.resource.Dataset.get_or_create_by_full_path")
    @mock.patch("quartzbio.resource.DatasetTemplate.create")
    @mock.patch("quartzbio.resource.DatasetTemplate.retrieve")
    ...
    def test_create_dataset(self):
        args = [
            "create-dataset",
            "quartzbio:test_vault:/test-dataset",
            "--capacity",
            "small",
        ]
    ...
    def test_create_dataset_by_filename(self):
        args = [
            "create-dataset",
            "quartzbio:test_vault:/test-dataset-filename",
            "--capacity",
            "small",
            "--tag",
            "tag_test",
...
class ImportTests(CLITests):
    @mock.patch("quartzbio.resource.DatasetTemplate.retrieve")
    @mock.patch("quartzbio.resource.DatasetTemplate.create")
    @mock.patch("quartzbio.resource.Vault.get_or_create_uploads_path")
    @mock.patch("quartzbio.resource.Vault.get_by_full_path")
    @mock.patch("quartzbio.resource.Vault.all")
    @mock.patch("quartzbio.resource.Object.all")
    @mock.patch("quartzbio.resource.Object.upload_file")
    @mock.patch("quartzbio.resource.Object.create")
    @mock.patch("quartzbio.resource.DatasetImport.create")
    @mock.patch("quartzbio.resource.Dataset.get_or_create_by_full_path")
    ...
    def test_import_file(self):
        ...
        args = [
            ...
            "--commit-mode",
            "overwrite",
            "quartzbio:mock_vault:/test-dataset",
            file_,
        ]

        imports, ds = self._test_import_file(args)
        self.assertEqual(ds.full_path, "quartzbio:mock_vault:/test-dataset")
...
class UploadTests(CLITests):
    @mock.patch("quartzbio.resource.apiresource.ListableAPIResource._retrieve_helper")
    @mock.patch("quartzbio.resource.Vault.get_by_full_path")
    @mock.patch("quartzbio.resource.Vault.all")
    @mock.patch("quartzbio.resource.Object.all")
    @mock.patch("quartzbio.resource.Object.create")
    @mock.patch("quartzbio.resource.Object.upload_file")
    @mock.patch("quartzbio.global_search.GlobalSearch.filter")
    ...
    def test_upload_file(self):
        ...
        args = ["upload", "--full-path", "quartzbio:test_vault:/test-folder", file_]
        ...
        args = [
            "upload",
            "--full-path",
            "quartzbio:test_vault:/test-folder",
            "--create-full-path",
            file_,
        ]
    ...
    def test_upload_directories(self):
        ...
        args = [
            "upload",
            "--full-path",
            "quartzbio:test_vault:/test-folder-upload",
            folder_,
        ]
        with self.assertRaises(NotFoundError):
            self._test_upload_command(args, fail_lookup=True)
    ...
    @mock.patch("quartzbio.resource.Object.all")
    @mock.patch("quartzbio.resource.Object.create")
    @mock.patch("quartzbio.resource.Vault.create")
...
class DownloadTests(CLITests):
    @mock.patch("quartzbio.resource.Object.all")
    @mock.patch("quartzbio.resource.apiresource.DownloadableAPIResource.download")
    ...
    def test_download_file(self):
        args = ["download", "quartzbio:mock_vault:/test-file", "."]
    ...
    @mock.patch("quartzbio.resource.object.Object.retrieve")
    @mock.patch("os.walk")
    @mock.patch("os.rmdir")
    ...
    def _test_download_folder(
        ...
        remote_objects = [
            ...
            fake_vault_create(
                id=5,
                full_path="test-folder/subfolder/vault",
                name="vault",
                class_name="Vault",
    ...
    def test_download_folder(self):
        args = ["download", "--recursive", "quartzbio:mock_vault:/test-folder", "."]
        ...
        args = [
            ...
            "--exclude",
            "*",
            "quartzbio:mock_vault:/test-folder/",
            ".",
        ]
        ...
        args = ["download", "--recursive", "quartzbio:mock_vault:/test-file/*", "."]
        with self.assertRaises(Exception):
            self._test_download_folder(args, download_success=False)


class LsTests(CLITests):
    @mock.patch("quartzbio.resource.object.Object.all")
