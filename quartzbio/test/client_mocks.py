...
from quartzbio.resource.quartzbio_object import convert_to_quartzbio_object
...
class Fake201Response(object):
    ...
    def __init__(self, data):
        self.object = {"id": data.get("id", 100), "class_name": self.class_name}

    def json(self):
        return self.object

    def create(self, *args, **kwargs):
        return convert_to_quartzbio_object(self.object)
    ...
    def _retrieve_helper(self, model_name, field_name, error_value, *args, **kwargs):
        obj = self.create()
    ...
    def all(self, *args, **kwargs):
        class ExtendedList(list):
            def quartzbio_objects(self):
                return convert_to_quartzbio_object(self)
    ...
    def update_paths(self):
        ...
        if not self.object["path"]:
            self.object["path"] = "/{0}".format(
                self.object.get("filename", self.object.get("vault_object_filename"))
            )
...
class FakeVaultResponse(Fake201Response):
    ...
    def __init__(self, data):
        self.object = {
            ...
            "provider": "QuartzBio",
            "id": 100,
            "full_path": "quartzbio:test_vault",
        }
        self.object.update(data)
...
def fake_object_retrieve(*args, **kwargs):
    return FakeObjectResponse(kwargs)._retrieve_helper("LogicalObject", *args, **kwargs)
...
def fake_dataset_get_or_create(*args, **kwargs):
    from quartzbio.resource import Object
